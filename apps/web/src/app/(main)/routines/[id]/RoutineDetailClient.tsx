                            ...
                            <table className="w-full min-w-[32rem] table-fixed text-left text-sm">
                              <thead>
                                <tr className="border-b border-slate-200 text-xs text-slate-500">
                                  <th scope="col" className="w-1/4 px-3 py-2 font-medium">세트</th>
                                  <th scope="col" className="w-1/4 px-3 py-2 font-medium">무게(kg)</th>
                                  <th scope="col" className="w-1/4 px-3 py-2 font-medium">반복횟수</th>
                                  <th scope="col" className="w-1/4 px-3 py-2 font-medium">시간(분)</th>
                                </tr>
                              </thead>
                              <tbody className="divide-y divide-slate-100 text-slate-700">
                                {sets.map((set, index) => (
                                  <tr key={set.id}>
                                    ...
                                    <td className="px-3 py-2.5">{set.durationMinutes ?? "—"}</td>
                                  </tr>
                                ))}
                              </tbody>
                            </table>
